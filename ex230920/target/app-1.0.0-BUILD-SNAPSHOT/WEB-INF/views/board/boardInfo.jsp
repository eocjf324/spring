...
<body>
	<table>
		...
		<tr>
			<th>첨부파일</th>
			<!-- 사진불러오는 2가지 방식 
				 이미지 null일경우 choose 처리-->
		
			<c:choose>
				<c:when test="${not empty boardInfo.image}">
				<%-- 	<td><img style="width:80%;" src="${pageContext.request.contextPath}/resources/image/${boardInfo.image}" width = "200" height ="200"></td> --%>
					<td><img style="width:80%;" src="<c:url value="/resources/image/${boardInfo.image}"/>"> </td> 
				</c:when>
				<c:otherwise>
